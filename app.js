...
//*Item Objects*//
var cola = {cost: 1.00, stock: 3, displayName: "Cola"};
var chips = {cost: 0.50, stock: 3, displayName: "Chips"};
var candy = {cost: 0.65, stock: 3, displayName: "Candy"};

//*Values of Coins by Weight*//
var pennyValue = 0.01, nickelValue = 0.05, dimeValue = 0.10, quarterValue = 0.25;

//*Initial Display Values*//
display.innerHTML = defaultMessage;
coinReturn.innerHTML = coinReturnValue;
itemSlot.innerHTML = "";
stockDisplay.innerHTML = ("Machine Stock - " + "Cola: " + cola.stock + " Chips: " + chips.stock + " Candy: " + chips.stock);
...
function updateStock(){
	stockDisplay.innerHTML = ("Machine Stock - " + "Cola: " + cola.stock + " Chips: " + chips.stock + " Candy: " + candy.stock);
}
